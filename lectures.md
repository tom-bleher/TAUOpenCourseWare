...
**אוסף הקלטות \- פיזיקה \+ מתמטיקה: TAU**

[מתמטיקה \- תואר ראשון](#מתמטיקה---תואר-ראשון)

[מתמטיקה \- תואר שני](#מתמטיקה---תואר-שני)

[פיזיקה \- תואר ראשון](#פיזיקה---תואר-ראשון)

[פיזיקה \- תואר שני](#פיזיקה---תואר-שני)

**אוספי פיזיקה+מתמטיקה נוספים**  
אוסף הקלטות : [DeveloperY](https://github.com/Developer-Y/math-science-video-lectures?tab=readme-ov-file)   
רשימות מוקלדות מתמטיקה ופיזיקה (אוקספורד): [Oxford math+physics](https://courses.maths.ox.ac.uk/)   
רשימות מוקלדות מתמטיקה ופיזיקה (קיימברידג'): [https://dec41.user.srcf.net/notes](https://dec41.user.srcf.net/notes/) 

אוסף ספרי ורשימות (רק מתמטיקה): [Realnotcomplex](https://realnotcomplex.com/)  
אוסף רשימות מוקלדות מתמטיקה (אוני' עברית): [https://digmi.org/lecture-notes/](https://digmi.org/lecture-notes/)

אוסף רשימות מוקלדות פיזיקה (קיימברידג'): [David Tong](https://www.damtp.cam.ac.uk/user/tong/teaching.html) 
